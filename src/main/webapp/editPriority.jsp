...
<body style="margin:0;padding:0;background-color:rgb(243, 245, 245);">
	...
	<div style="position:relative;width:100%;height:100px;background-color:rgb(25, 28, 36);font-family:arial;color:white;font-size:10pt;margin-top:1px">
		...
		<input id="name" style="position:absolute;left:50%;top:5px;margin-left:-100px;width:200px;" type="text" name="Name" value="${priority.value}"/>
		...
		<input id="submitBtn" style="position:absolute;left:50%;top:60px;margin-left:-100px;width:204px;border:1px solid #3079ed;color:#fff;background-color:#4d90fe;border-radius:3px;height:30px;font-size:12pt;font-weight:bold;" type="button" value="Edit">
	</div>
