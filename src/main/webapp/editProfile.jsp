...
<head>
	...
	<script>
		...
		function adminOnClick() {
			...
			change("${user.id}", "/issuetracker/profile/edit", data);
		}
...
<body style="margin:0;padding:0;background-color:rgb(243, 245, 245);">
	...
	<div style="position:relative;width:100%;height:230px;background-color:rgb(25, 28, 36);font-family:arial;color:white;font-size:10pt;margin-top:1px">
			...
			<input id="fName" style="position:absolute;left:50%;top:5px;margin-left:-100px;width:200px;" type="text" name="First name" value="${user.firstName}"/>
			
			<span style="position:absolute;right:50%;top:35px;margin-right:100px;">Last name:</span>
			<input id="lName" style="position:absolute;left:50%;top:30px;margin-left:-100px;width:200px;" type="text" name="Last name" value="${user.lastName}"/>
			
			<span style="position:absolute;right:50%;top:60px;margin-right:100px;">E-mail:</span>
			<input id="email" style="position:absolute;left:50%;top:55px;margin-left:-100px;width:200px;" type="text" name="E-mail" value="${user.emailAddress}"/>
			...
			<c:choose>
				...
				<c:when test="${user.role.value eq 'user'}">
					<div style="text-align:center;position:absolute;top:85px;width:100%">
						<span id="msg" style="font-size:10pt;color:red;margin:auto;"></span>
					</div>
					<input id="submitBtn" style="position:absolute;left:50%;top:110px;margin-left:-100px;width:204px;border:1px solid #3079ed;color:#fff;background-color: #4d90fe;border-radius:3px;height:30px;font-size:12pt;font-weight:bold;" type="button" value="Edit">
				</c:when>
			</c:choose>
		</div>
	<c:choose>
